      ...
      <div className='flex flex-col lg:px-[100px] md:px-[60px] px-[30px] my-[100px] '>
        <div className='flex justify-around items-center lg:flex-row flex-col'>
          <div className='max-w-[275px] min-w-[150px] w-[40%] mb-[40px]'>
            <div className={`lg:rounded-[17px] md:rounded-[14px] rounded-[11px] aspect-[2/1] h-auto bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1476357471311-43c0db9fb2b4?crop=entropy&cs=srgb&fm=jpg&ixid=Mnw3MjAxN3wwfDF8c2VhcmNofDIwfHxkZXNpZ258ZW58MHx8fHwxNjQxODY5NDU1&ixlib=rb-1.2.1&q=85&q=85&fmt=jpg&crop=entropy&cs=tinysrgb&w=450')]`}></div>
            <h3 className='font-Lora text-[18px]'>UI/ UX Designer</h3>
          </div>
          <div className=' max-w-[275px] min-w-[150px] w-[40%] mb-[40px]'>
            <div className={`lg:rounded-[17px] md:rounded-[14px] rounded-[11px]  aspect-[2/1] h-auto bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1587620962725-abab7fe55159?crop=entropy&cs=srgb&fm=jpg&ixid=Mnw3MjAxN3wwfDF8c2VhcmNofDN8fGNvZGV8ZW58MHx8fHwxNjQxOTUyNjQ5&ixlib=rb-1.2.1&q=85&q=85&fmt=jpg&crop=entropy&cs=tinysrgb&w=450')]`}></div>
            <h3 className='font-Lora text-[18px]'>Frontend Developer</h3>
          </div>
          <div className='max-w-[275px] min-w-[150px] w-[40%] mb-[40px]'>
            <div className={`lg:rounded-[17px] md:rounded-[14px] rounded-[11px] aspect-[2/1] h-auto bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1626785774573-4b799315345d?crop=entropy&cs=srgb&fm=jpg&ixid=Mnw3MjAxN3wwfDF8c2VhcmNofDF8fGdyYXBoaWMlMjBkZXNpZ258ZW58MHx8fHwxNjQxOTUyNzUz&ixlib=rb-1.2.1&q=85&q=85&fmt=jpg&crop=entropy&cs=tinysrgb&w=450')]`}></div>
        ...
        <div className='flex flex-col items-center lg:pt-[30px] md:px-[20px] px-[10px]'>
          <h2 className='font-Lora md:text-[30px] text-[20px] mb-[20px]'>Want to learn more about me?</h2>
